...
{	
	...
	public function show(){
		...
		$consultas=Consulta::allByUser($_SESSION['usuario_id']);
		$lista_consultas="";
	...
	//Retorna una lista de consultas. 
	public function buscarExtendida(){
		$filtros=array('usuario'=>$_SESSION['usuario_id'],
			'numero'=>$_POST['numero'],
			'nombre'=>$_POST['nombre'],
			'apellido'=>$_POST['apellido']);
		$lista_consultas=Consulta::allByHisto($filtros);
		$botones=0;
		require_once('Views/Consulta/show.php');
		/*
