...
{	
	...
	public function show(){
		$historias=HistoClinica::allByUser($_SESSION['usuario_id']);
		//var_dump($historias);
		//die();
	...
	public function buscarExtendida(){
		$filtros=array('usuario'=>$_SESSION['usuario_id'],'numero'=>$_POST['numero'], 'nombre'=>$_POST['nombre'],'apellido'=>$_POST['apellido']);
		//print_r($filtros);
		$lista_historias=HistoClinica::allByPaciente($filtros);
		$botones=0;
		require_once('Views/Historia/show.php');
	}	
