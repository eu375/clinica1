<?php
	...
	$controllers= array(
						...
						'paciente'=>['register','save', 'show', 'showupdate','update', 'delete','buscar','buscarExtendida'],
						'historia'=>['register','save', 'show', 'showupdate','update', 'delete','reporteHistorico','buscar','buscarExtendida'],
						'consulta'=>['register','save','show', 'showupdate','update','recetaPdf','buscar','buscarExtendida']
						);
