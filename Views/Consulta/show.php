...
<h1>Resumen Consultas</h1>
	<form class="form-inline" action="?controller=consulta&action=buscarExtendida" method="post">
	<div class="form-group row">
	  <div class="col-xs-4">
	    <input class="form-control" name="numero" type="text" placeholder="N. Historia Clinica">
	  </div>
	</div>
	<div class="form-group row">
	  <div class="col-xs-4">
	...
	<div class="form-group row">
	 <div class="col-xs-4">
	 	<button type="button" class="btn btn-success" onclick="location.href='?controller=consulta&action=show'"><span class="glyphicon glyphicon-erase"></span> Limpiar</button>
	  </div>
	</div>	
	</form>
		...
		<table class="table table-hover">
			...
			<?php foreach ($lista_consultas as $consulta) {?>		
				<tr>
					...
					<td><?php $paciente=Paciente::getById($consulta->getPaciente()); echo $paciente->getNombres(); ?></td>
					<td><?php $paciente=Paciente::getById($consulta->getPaciente());echo $paciente->getApellidos();?></td>
