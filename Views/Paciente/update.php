...
<div class="container">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="number" class="form-control" id="dui" name="dui" value="<?php echo $paciente->getCedula(); ?>" readonly="false" required="true" autocomplete="off">
      </div>
    </div>
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">    
        <div class="input-group input-append date" id="datePicker">
                <input type="text" class="form-control" name="date"  required="true" value="<?php echo $paciente->getFnacimiento(); ?>" autocomplete="off"/>
